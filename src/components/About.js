        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-12 col-12 text-center">
                    <h2 className="mb-5" style={{color:'red'}}>DailyDose a NewsApp</h2>
                </div>

                <div className="col-lg-4 col-12">
                    <nav id="navbar-example3" className="h-100 flex-column align-items-center">
                        <nav className="nav nav-pills flex-column">
                            <a className="nav-link smoothscroll" href="#introduction"><strong>Introduction</strong></a>

                            <a className="nav-link smoothscroll" href="#Features"><strong>Features Provided</strong></a>

                            <a className="nav-link smoothscroll" href="#About-Developers"><strong>About Developers</strong></a>

                            <a className="nav-link smoothscroll" href="#FAQ"><strong>Why to choose DailyDose?</strong></a>
...
{/* Introduction Started */}
                        <div className="scrollspy-example-item" id="introduction">
                            <h4>Introducing <span style={{color:'red'}}>DailyDose</span> </h4>
                            <p style={{borderBottom:'3px solid red', maxWidth:'33%'}}></p>
                            ...
                            <div className="logo" style={{display:'flex', justifyContent:'center'}}>
                                <img src="/images/logo.png" alt="DailyDose" title="DailyDose" style={{maxWidth:'50%'}}/>
                            </div>
...
{/* Features Started */}
                        <div className="scrollspy-example-item" >
                            <h4 id="Features">Features that <span style={{color:'red'}}>dailyDose</span> Provides</h4>
                            <p style={{borderBottom:'3px solid red', maxWidth:'49%'}}></p>
...
{/* About Developers Started */}
                        <div className="scrollspy-example-item" id="About-Developers">
                            <h4>About Developers of <span style={{color:'red'}}>DailyDose</span></h4>
                            <p style={{borderBottom:'3px solid red', maxWidth:'46%'}}></p>
                            ...
                            <ul>
                                ...
                                <li><p>Credits for Creativity , Color and Designed goes to <span style={{color:'red'}}>Love Rathore</span> (<strong>Designer</strong>)</p></li>
                                <li><p>Credits for Development,Implementation and Project Leads goes to <span style={{color:'red'}}>Aman Mittal</span> (<strong>Project Leader, Developer</strong>)</p></li>
                            </ul>
                             ...
                             <div className="row">
                                ...
                                <div className="col-lg-6 col-12 mb-1">
                                    <img src="/images/ph2.jpg" className="scrollspy-example-item-image img-fluid" alt="Designer" title="Designer" style={{height:'95%'}}/>
                                </div>
                            </div>
                        </div>
...
{/* FAQ Started */}
                        <div className="scrollspy-example-item" id="FAQ">
                            <h4>FAQ (<span style={{color:'red'}}>F</span>requently <span style={{color:'red'}}>A</span>sked <span style={{color:'red'}}>Q</span>uestion)</h4>
                            <p style={{borderBottom:'3px solid red', maxWidth:'50%'}}></p>


                                <h5>1.What is <span style={{color:'red'}}>DailyDose</span> News App?</h5>
                                 <p>DailyDose News App is your go-to source for staying informed about current events, breaking news, and trending stories from around the world. We curate content from reputable sources to ensure that you receive accurate and up-to-date information.</p>

                                <h5>2. How do I navigate the app?</h5>
                                 <p>Our app is designed to be user-friendly and intuitive. Simply browse through the different sections, such as Top Stories, Politics, Technology, and more, to find the news that interests you. You can also use the search function to look for specific topics or articles.</p>

                                <h5>3. Is the news on <span style={{color:'red'}}>DailyDose</span> App reliable?</h5>
                                <p> Yes, we take the credibility of our news very seriously. We have a team of experienced journalists who verify the information before it is published on our platform. Additionally, we source our news from reputable sources to ensure accuracy and reliability.</p>

                                <h5>4. Can I customize my news feed?</h5>
                                 <p>Absolutely! DailyDose News App allows you to personalize your news feed based on your interests. You can choose to follow specific topics, sources, or even customize your feed based on your location.</p>

                                <h5>5. How often is the news updated?</h5>
                                 <p>We update our news feed regularly throughout the day to keep you informed about the latest developments. You can expect to see new articles and updates as they happen.</p>

                                <h5>6. Is <span style={{color:'red'}}>DailyDose</span> News App free to use?</h5>
                                <p>Yes, our app is free to download and use. However, some premium features may require a subscription.</p>

                                <h5>7. How can I provide feedback or report a problem?</h5>
                                 <p>We value your feedback! If you have any suggestions, questions, or encounter any issues while using our app, please don't hesitate to contact our support team. You can reach us through the app or via email at <a href="mailto:support@dailydosenews.com.">support@dailydosenews.com.</a></p>

                                <p>We hope this FAQ section helps address any questions you may have about the DailyDose News App. Thank you for choosing us as your trusted source for news updates!</p>
