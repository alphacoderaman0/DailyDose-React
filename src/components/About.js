        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-12 col-12 text-center">
                    ...
                    <p style={{borderBottom:'4px solid red',width:'30%', margin:'auto',borderRadius:'10px',marginTop:'-32px'}}></p>
                </div>

                <div className="col-lg-4 col-12">
                    <nav id="navbar-example3" className="h-100 flex-column align-items-center">
                        <nav className="nav nav-pills flex-column" style={{backgroundColor: props.mode === 'dark' ? '#71727538' : 'white'}}>
...
{/* Introduction Started */}
                        <div className="scrollspy-example-item" id="introduction" >
                            <h4 style={myStyle}>Introducing <span style={{color:'red'}}>DailyDose</span> </h4>
                            ...
                            <p className="blockquote" style={{color: props.mode === 'dark' ? 'white' : '#042743',
    backgroundColor: props.mode === 'dark' ? '#717275' : 'white'}}>
...
{/* Features Started */}
                        <div className="scrollspy-example-item" >
                            <h4 id="Features" style={myStyle}>Features that <span style={{color:'red'}}>dailyDose</span> Provides</h4>
...
{/* About Developers Started */}
                        <div className="scrollspy-example-item" id="About-Developers">
                            <h4 style={myStyle}>About Developers of <span style={{color:'red'}}>DailyDose</span></h4>
...
{/* FAQ Started */}
                        <div className="scrollspy-example-item" id="FAQ">
                            <h4 style={myStyle}>FAQ (<span style={{color:'red'}}>F</span>requently <span style={{color:'red'}}>A</span>sked <span style={{color:'red'}}>Q</span>uestion)</h4>
                            <p style={{borderBottom:'3px solid red', maxWidth:'50%'}}></p>


                                <h5 style={myStyle}>1.What is <span style={{color:'red'}}>DailyDose</span> News App?</h5>
                                ...
                                <h5 style={myStyle}>3. Is the news on <span style={{color:'red'}}>DailyDose</span> App reliable?</h5>
                                ...
                                <h5 style={myStyle}>6. Is <span style={{color:'red'}}>DailyDose</span> News App free to use?</h5>
                                <p>Yes, our app is free to download and use. However, some premium features may require a subscription.</p>

                                <h5 style={myStyle}>7. How can I provide feedback or report a problem?</h5>
